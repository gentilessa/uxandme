...
<CaseStudyMeta role="Lead UX/UI Designer" platform="Admin portal, mobile field app, public provenance page" domain="Supply chain traceability, SaaS, cross-platform design systems" />
...
<aside aria-label="What this project demonstrates" class="starlight-aside starlight-aside--note"> <p class="starlight-aside__title" aria-hidden="true"> <svg aria-hidden="true" class="starlight-aside__icon" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style="--sl-icon-size: 1em;"><path d="M12 11a1 1 0 0 0-1 1v4a1 1 0 0 0 2 0v-4a1 1 0 0 0-1-1Zm.38-3.92a1 1 0 0 0-.76 0 1 1 0 0 0-.33.21 1.15 1.15 0 0 0-.21.33 1 1 0 0 0 .21 1.09c.097.088.209.16.33.21A1 1 0 0 0 13 8a1.05 1.05 0 0 0-.29-.71 1 1 0 0 0-.33-.21ZM12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm0 18a8 8 0 1 1 0-16.001A8 8 0 0 1 12 20Z"></path></svg>What this project demonstrates </p> <div class="starlight-aside__content"> <ul><li>Designing a shared product language across web, mobile, and public-facing experiences.</li><li>Building a design system as operational infrastructure, not just a visual library.</li><li>Balancing consistency with the real needs of different users and contexts.</li><li>Creating scalable foundations for collaboration between design, product, and engineering.</li></ul> </div> </aside>
