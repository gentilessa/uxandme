...
<CaseStudyMeta role="UX strategy, global research, workflow redesign, service design" platform="Salesforce Lightning" domain="Customer experience strategy, CRM, internal tooling, post-merger transformation" />
